  ...
  return (
    <div className="flex flex-col items-center">
      <button
        type="button"
        onClick={onToggle}
        className={`grid h-[120px] w-[120px] place-items-center rounded-full border ${recording ? "animate-pulseVoice border-brand-orange bg-brand-orange/15" : "border-brand-orange/20 bg-[radial-gradient(circle,rgba(218,119,86,0.12)_0%,rgba(218,119,86,0.04)_70%,transparent_100%)]"} transition hover:scale-[1.03]`}
      >
