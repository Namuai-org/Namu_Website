    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_code_projects", x => x.Id);
                    table.ForeignKey(
                        name: "FK_code_projects_sessions_SessionId",
                        column: x => x.SessionId,
                        principalTable: "sessions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_code_projects_users_UserId",
                        column: x => x.UserId,
                        principalTable: "users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Length = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_create_outputs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_create_outputs_sessions_SessionId",
                        column: x => x.SessionId,
                        principalTable: "sessions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_create_outputs_users_UserId",
                        column: x => x.UserId,
                        principalTable: "users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_code_files_code_projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "code_projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_code_files_users_UserId",
                        column: x => x.UserId,
                        principalTable: "users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_code_files_ProjectId_Filename",
                table: "code_files",
                columns: new[] { "ProjectId", "Filename" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_code_files_UserId",
                table: "code_files",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_code_projects_SessionId",
                table: "code_projects",
                column: "SessionId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_code_projects_UserId",
                table: "code_projects",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_create_outputs_SessionId",
                table: "create_outputs",
                column: "SessionId");

            migrationBuilder.CreateIndex(
                name: "IX_create_outputs_UserId",
                table: "create_outputs",
                column: "UserId");
